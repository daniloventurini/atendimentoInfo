 ...
 * @author pos
 */
public class CursoTela extends javax.swing.JDialog {

    private Curso objeto;
    private CursoControler controle;
    private List<Curso> lista;

    /** Creates new form CursoForm */
    public CursoTela(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        controle = CursoControler.getInstance();
        montaTabela();
        validaBotoes("inicio");
    }
    ...
    public void montaTabela(){
        ...
        for (Iterator<Curso> it = lista.iterator(); it.hasNext();){
            Curso curso = it.next();
            modelo.addRow(new Object[]{curso.getId(),
            curso.getNome(),curso.getDuracao()});
        }
    ...
    public boolean verificaCampos(){
        if (fNome.getText().equals("") ||
            ...
            JOptionPane.showMessageDialog(null,
                    "O campo Nome do curso deve ser preenchio!",
                    "Atenção", JOptionPane.WARNING_MESSAGE);
            fNome.requestFocus();
            return false;
        } else if (fDuração.getText().equals("") ||
                fDuração.getText().equals(null)){
            JOptionPane.showMessageDialog(null,
                    "O campo UF do curso deve ser preenchio!",
                    "Atenção", JOptionPane.WARNING_MESSAGE);
            fDuração.requestFocus();
            return false;
        } else {
            return true;
        }
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(fNome)
                            .addComponent(fDuração, javax.swing.GroupLayout.DEFAULT_SIZE, 313, Short.MAX_VALUE))
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(cOpcao, javax.swing.GroupLayout.PREFERRED_SIZE, 76, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    .addComponent(jPanel2, javax.swing.GroupLayout.Alignment.LEADING, 0, 480, Short.MAX_VALUE)
    ...
    private void tabelaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaMouseClicked
        ...
        fDuração.setText(objeto.getDuracao());
    ...
    private void bSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bSalvarActionPerformed
        ...
        objeto.setDuracao(fDuração.getText());
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CursoTela dialog = new CursoTela(new javax.swing.JFrame(), true);
